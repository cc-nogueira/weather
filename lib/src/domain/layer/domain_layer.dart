...
@riverpod
DomainConfiguration domainConfiguration(DomainConfigurationRef ref) => ref.watch(domainLayerProvider).configure;

/// PreferencesUsecase singleton provider
@Riverpod(keepAlive: true)
PreferencesUsecase preferencesUsecase(PreferencesUsecaseRef ref) => ref.watch(domainLayerProvider).preferencesUsecase;
...
@Riverpod(keepAlive: true)
TimeZoneUsecase timeZoneUsecase(TimeZoneUsecaseRef ref) => ref.watch(domainLayerProvider).timeUsecase;

/// WeatherUsecase singleton provider
@Riverpod(keepAlive: true)
WeatherUsecase weatherUsecase(WeatherUsecaseRef ref) => ref.watch(domainLayerProvider).weatherUsecase;
