...
class PreferenceMapper extends EntityMapper<Preference, PreferenceModel> {
  ...
  @override
  Preference mapEntity(PreferenceModel model) => Preference(id: model.id, key: model.key, value: model.value);

  /// Map a domain entity to a persistence model.
  @override
  PreferenceModel mapModel(Preference entity) => PreferenceModel(id: entity.id, key: entity.key, value: entity.value);
}
