...
class SnowScaleChart extends ConsumerWidget {
  const SnowScaleChart({super.key, required this.intensityGender, required this.chartName, this.height});
...
class _SnowScaleChart extends IntensityScaleChart<Speed> with SnowMixin {
  const _SnowScaleChart({required super.unit, required super.intensityGender, required super.chartName, super.height});
